...
async function main() {
  ...
  const walletAddress = Address.parse('EQBgEeRt56W-3CbBziuKuBhs9YDw6EitZ4wyRjpNOpPWfRX5');
  ...
  storeUint(0, 1). // indicate that it is an internal message -> int_msg_info$0
    ...
    const mnemonic = 'panda position panther daring exclude emotion spirit lucky rely lunch orange scene lemon tape report upon angry begin fall ancient antenna spider seed admit'; // word1 word2 word3
